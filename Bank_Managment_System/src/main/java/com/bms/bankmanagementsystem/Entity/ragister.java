...
public class ragister {
    ...
    private Long accountNumber; // Adding accountNumber field
    ...
    public String toString() {
        return "ragister [customerId=" + customerId + ", accountNumber=" + accountNumber + ", firstName=" + firstName
    ...
    public ragister(Long customerId, Long accountNumber, String firstName, String lastName, String accountType,
